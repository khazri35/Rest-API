...
const getcontacts = async (req, res) => {
  try {
    ...
    res.status(200).send({ contacts: result, message: 'get all contact' })
  } catch (error) {
...
const getcontact = async (req, res) => {
  try {
    ...
    res.status(200).send({ contact: result, message: 'get one contact' })
  } catch (error) {
...
const deletecontact = async (req, res) => {
  ...
  try {
    ...
    result
      ? res
          .status(200)
          .send({ contact: result, message: 'this contact is deleted' })
...
const updatecontact = async (req, res) => {
  try {
    ...
    result.nModified
      ? res
          .status(200)
          .send({ response: result, message: 'this contact is updated' })
      : res.send({ contact: result, message: 'already updated' })
  } catch (error) {
